        ...
        <div className="mx-auto max-w-6xl px-5 py-8 md:px-8 md:py-10">
            ...
            <div className="max-w-4xl">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link
                  ...
                  className="rounded-full bg-[#1D4ED8] px-5 py-3 text-sm font-semibold text-white shadow-[0_10px_25px_rgba(29,78,216,0.20)]"
                >
          ...
          <section className="mb-8 grid gap-4 md:grid-cols-4">
            <div className="rounded-[24px] border border-[#E6EBF2] bg-white p-6 shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
              ...
              <div className="mt-3 text-xl font-semibold text-[#0F172A]">{latest.sku}</div>
            </div>

            <div className="rounded-[24px] border border-[#E6EBF2] bg-white p-6 shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
              <div className="text-sm font-medium text-[#6A7788]">Market</div>
              <div className="mt-3 text-xl font-semibold text-[#0F172A]">{latest.market}</div>
            </div>

            <div className="rounded-[24px] border border-[#E6EBF2] bg-white p-6 shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
              <div className="text-sm font-medium text-[#6A7788]">Güncel Fiyat</div>
              <div className="mt-3 text-xl font-semibold text-[#0F172A]">
          ...
          <section className="overflow-hidden rounded-[28px] border border-[#E6EBF2] bg-white shadow-[0_10px_35px_rgba(15,23,42,0.05)]">
            <div className="border-b border-[#EEF2F6] px-6 py-5">
              <h2 className="text-2xl font-semibold text-[#0F172A]">Fiyat Geçmişi</h2>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm">
                ...
                <tbody>
                  ...
                  {!history.length && (
                    <tr>
                      <td colSpan={3} className="px-5 py-12 text-center text-[#7A8798]">
                        Geçmiş veri yok
                      </td>
                    </tr>
                  )}
